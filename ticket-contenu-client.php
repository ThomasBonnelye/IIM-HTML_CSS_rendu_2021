...
<div class="row">
    <div class="col-sm-8">
        ...
        <div class="buttons">
            <button type="button" class="btn btn-danger" onclick="window.location.href='tickets-client.php'">Fermer le ticket</button>
            <button type="button" class="btn btn-primary"onclick="window.location.href='tickets-client.php'">Envoyer</button>
        </div>
    </div>
